...
export default function Page() {
  ...
  const handleSubmit = async () => {
    ...
    if (!error) {
      ...
      //setShowVerification(true); // Show it only after successful submission
    }
  };
  ...
  if (
    ...
    return (
      <View style={styles.verificationContainer}>
        ...
        />
        {errors.fields.code && (
          <Text style={styles.error}>{setError(errors.fields.code.message)}</Text>
        )}
        <Pressable
          style={({ pressed }) => [
            styles.button,
    ...
    >
      <View style={styles.container}>
        ...
        {errors.fields.emailAddress && (
          <Text style={styles.error}>{setError(errors.fields.emailAddress.message)}</Text>
        )}
